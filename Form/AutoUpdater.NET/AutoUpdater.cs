...
namespace AutoUpdaterDotNET
{
    ...
    public static class AutoUpdater
    {
        ...
        private static void BackgroundWorkerDoWork(object sender, DoWorkEventArgs e)
        {
                        ...
                        try
                        {
                            ...
                            if (appCastItems != null)
                            {
                                foreach (XmlNode item in appCastItems)
                                {
                                    ...
                                    XmlNode storeApply = item.SelectSingleNode("storeApply");
                                    args.ApplyStore= storeApply?.InnerText;
                                }
                            }
                        }
            ...
            if (args.CurrentVersion == null || string.IsNullOrEmpty(args.DownloadURL)
                || (args.ApplyStore != null && storeId != args.ApplyStore)
                )
            {
                webResponse.Close();
                if (ReportErrors)
        ...
        private static void Exit()
        {
            ...
            {
                foreach (var exchangeProcess in Process.GetProcessesByName("AutoExchangeData"))
                {
                    exchangeProcess.Kill();
                }
    ...
    public class UpdateInfoEventArgs : EventArgs
    {
        ...
        public string ApplyStore { get; set; }
        /// <summary>
