...
namespace POS.Repository.ViewModels
{
    public class StoreReportModel
    {
        ...
        public TypeReportModel CardReport { get; set; }
    ...
    public class TypeReportModel
    {
        ...
        public double OtherPayment { get; set; } // Khác
        public double GiftTalkPayment { get; set; }//GiftTalk
        public double MoMoPayment { get; set; }//MoMo
        public double ZaloPayPayment { get; set; }//ZaloPay

        public double GrabPayPayment { get; set; }
        public double GrabFoodPayment { get; set; }
    }
