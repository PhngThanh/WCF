...
{
    internal class PGPDecryptHelper
    {
        internal string PrivateKeyData { get; set; }
        internal string EncryptedData { get; set; }
        ...
        internal PGPDecryptHelper(string privateKeyData,string password, string encryptedData)
        {
        ...
        internal string GetDecryptedData()
        {
