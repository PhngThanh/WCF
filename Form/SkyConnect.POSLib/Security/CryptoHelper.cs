...
namespace SkyConnect.POS.Privacy.PGP
{
    public static class CryptoHelper
    {
        ...
        public static string EncryptPgpStringData(string inputData)
        {
            File.WriteAllText(TempData, inputData);
            // use armor: yes, use integrity check? yes?
            return EncryptPgpStringData(TempData, PublicKeyPath, true, true);
        }

        public static string EncryptPgpStringData(string inputFile, string publicKeyFile, bool armor, bool withIntegrityCheck)
        {
