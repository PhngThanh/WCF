...
namespace SkyConnect.POSLib.Security
{
    ...
    {
        internal static string DecryptFromString(string encryptedStr, string keyStr, string IVStr)
        {
        ...
        /// <param name="IV"></param>
        /// <returns></returns>
        internal static string EncryptFromString(string plainText, string keyStr, string IVStr)
        {
            var key = Convert.FromBase64String(keyStr);
            var IV = Convert.FromBase64String(IVStr);
