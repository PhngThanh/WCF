...
{
    public partial class OnScreenKeyboardDialog : Form
    {
        #region Constants
        ...
        private static OnScreenKeyboardDialog _instance;

        public OnScreenKeyboardDialog()
        {
            InitializeComponent();
        }
        ...
        public static void CreateInstance()
        {
            if (_instance == null)
            {
                _instance = new OnScreenKeyboardDialog();
            }
        }
        ...
        public static OnScreenKeyboardDialog Instance { get { return _instance; } }
